...
old = '''            [{"text": "💰 Narxini o‘zgartirish", "callback_data": f"eprice_{book_id}"}],
            [{"text": "🎁 Eski narx/chegirma", "callback_data": f"eoldprice_{book_id}"}],
            [{"text": "📦 Qoldig‘ini o‘zgartirish", "callback_data": f"estock_{book_id}"}],
'''
new = '''            [{"text": "💰 Narxini o‘zgartirish", "callback_data": f"eprice_{book_id}"}],
            [{"text": "📦 Qoldig‘ini o‘zgartirish", "callback_data": f"estock_{book_id}"}],
'''
assert t.count(old) == 1, t.count(old)
t = t.replace(old, new, 1)

old2 = '''            [{"text": "📸 Rasmni o‘zgartirish", "callback_data": f"ephoto_{book_id}"}],
            [{"text": "🔥 Tavsiya etilgan ON/OFF", "callback_data": f"erec_{book_id}"}],
'''
new2 = '''            [{"text": "📸 Rasmni o‘zgartirish", "callback_data": f"ephoto_{book_id}"}],
...
t = t.replace(anchor, callback + anchor, 1)
...
'''
assert t.count(anchor3) == 1, t.count(anchor3)
t = t.replace(anchor3, flow + anchor3, 1)
