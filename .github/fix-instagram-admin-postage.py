...
old2 = 'books_total = received - fee if customer_pays else received'
new2 = 'books_total = max(0, received - int(DELIVERY_FEE))'
if old2 not in s:
    raise SystemExit('instagram preview books_total pattern not found')
